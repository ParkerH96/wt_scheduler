<?php
  ...
  if(isset($_POST) && !empty($_POST)){
    ...
    $mysqli->query("UPDATE SHIFT SET employee_id = $employee_id, shift_date = '$shift_date', start_time = '$start_time', end_time = '$end_time', color = '$color' WHERE shift_id = $shift_id;");
